...
/*
    ...
    1) var - 사용하지 않는다.
    2) let 
    3) const -한 번 값을 초기화 하면 바꿀 수 없음
*/ 

//동적타입(Dynamic Typing)
//js는 변수의 타입을 명시적으로 지정하지 않고, 실행 중에 값에 따라 자동으로 타입이 결정됨
...
/*
    let은 var에서 같은 이름의 중복생성을 하지 못 하게 만든 자료형
...
/*
    ...
    2) snake_case -> 파이썬에서 주로 사용하며 단어의 시작마다 _로 구분을 해준다.
    3) PascalCase -> c# 및 ms 계열의 언어에서 많이 사용하는 방식. 매단어 시작은 무조건 대문자다.
*/ 
...
console.log(num1=="55"); //값만 확인
console.log(num1==="55"); //타입까지 확인
