...
/*
    ...
    *트랜잭션
    ...
    ROLLBACK: 한 트랜잭션에 담겨있는 변경사항들을 삭제(취소)한 후 마지막 COMMIT 시점으로 돌아가겠다.
...
/*
    ACID속성: 트랜잭션의 일관성과 신뢰성을 보장하기 위해 지켜야하는 네가지 핵심속성
