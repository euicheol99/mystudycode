...
SELECT EMP_NAME,ABS(TRUNC(HIRE_DATE-SYSDATE)) 근무일수1,TRUNC(SYSDATE-HIRE_DATE) 근무일수2
FROM EMPLOYEE;
...
--WHERE MON(TO_NUMBER(EMP_ID),2)=1;
