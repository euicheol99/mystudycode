...
ALTER TABLE DEPT_TABLE MODIFY DEPT_ID NUMBER; -- 기존의 데이터가 CHAR형식으로 들어있어서 안 됨

--DEPT_TITLE 컬럼들 VARCHAR2(40)으로 변경
...
--DEPT_COPY라는 이름의 테이블을 DEPT_TABLE의 값들을 가져와서 생성
...
--컬럼이 1개 남아있을 경우 컬럼이 삭제되면 테이블의 의미가 없어지기 때문에 삭제불가.
...
ALTER TABLE DEPT_TABLE RENAME CONSTRAINT SYS_C008514 TO DTABLE_ID_NN;
