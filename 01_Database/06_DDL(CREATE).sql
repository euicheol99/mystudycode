...
/*
    ...
    -테이블이란: 행과 열로 구성되는 가장 기본적인 데이터베이스 객체
                ...
                (DMNS용어 중 하나로,데이터를 일종의 표 형태로 표현한 것)
    ...
    *자료형
    -숫자(NUMBER)
    -문자(CHAR(바이트 크기) | VARCHAR2(바이트크기)) --> 반드시 크기를 지정해 줘야한다.
        -CHAR: 최대 2000바이트까지 지정가능 / 고정길이(고정된 글자 수의 데이터가 담길 경우)
        -VARCHAR:최대 4000바이트까지 지정가능 / 가변길이(몇 글자의 데이터가 들어올지 모르는 경우)
    -날짜(DATE)
*/
--회원에 대한 데이터를 담기 위한 테이블을 MEMBER 생성
CREATE TABLE MEMBER (
    MEM_NO NUMBER,
    MEM_ID VARCHAR2(20), --user01,alwaysjone(가변길이,최대 20자 사용가능) 아이디를 한글로 하면 바이트 크기가 커지고 조회하는데 시간이 오래걸림
    MEM_PWD VARCHAR2(20),
    MEM_NAME VARCHAR2(20),
    GENDER CHAR(3), --남,여(한글 1글자는 3바이트)
    PHONE VARCHAR2(13),
    EMAIL VARCHAR2(50),
    MEM_DATE DATE    
);
...
/*
    ...
    제약조건을 부여하는 방식은 크게 2가지가 있다. (컬럼레벨방식, 테이블 레벨방식)
    NOT NULL제약조건은 무조건 컬럼레벨방식만 가능하다.(무조건 컬럼 옆에다가 기술해야함)
*/

CREATE TABLE MEMBER (
    MEM_NO NUMBER NOT NULL,
    MEM_ID VARCHAR2(20) NOT NULL,  --user01,alwaysjone(가변길이,최대 20자 사용가능) 아이디를 한글로 하면 바이트 크기가 커지고 조회하는데 시간이 오래걸림
...
INSERT INTO MEM_PRI2
VALUES(2,'USER2','PASS2','홍길동',NULL,'010-1111-2222','AAA@NAVER.COM','24/12/23');
INSERT INTO MEM_PRI2
VALUES(3,'USER3','PASS3','홍길삼',NULL,'010-1111-2222','AAA@NAVER.COM','24/12/23');
INSERT INTO MEM_PRI2
VALUES(4,'USER4','PASS4','홍길사',NULL,'010-1111-2222','AAA@NAVER.COM','24/12/23');
...
INSERT INTO MEM
VALUES(2,'USER2','PASS2','홍길동',NULL,'010-1111-2222','AAA@NAVER.COM','24/12/23',10);

INSERT INTO MEM
VALUES(3,'USER3','PASS3','홍길삼',NULL,'010-1111-2222','AAA@NAVER.COM','24/12/23',30);

--유효하지 않은 회원등급번호가 정상적으로 INSERT 된다.
INSERT INTO MEM
VALUES(4,'USER4','PASS4','홍길사',NULL,'010-1111-2222','AAA@NAVER.COM','24/12/23',50);
...
SELECT * FROM MEM;
--MEM_GRADE(부모테이블) -|-------------<-MEM(자식테이블) 1대다 관계
...
DELETE FROM MEM_GRADE
WHERE GRADE_CODE=40;
--MEM테이블에서 40이라는 값을 사용하고 있지 않기 떄문에 삭제가 된다.
...
/*
    ...
    *삭제옵션: 부모테이블의 데이터 삭제시 그 데이터를 사용하고 있는 자식 테이블의 값을 어떻게 할것인가?
...
INSERT INTO MEM
VALUES(1,'USER1','PASS1','홍길순',NULL,NULL,NULL,NULL,NULL);

INSERT INTO MEM
VALUES(2,'USER2','PASS2','홍길동',NULL,NULL,NULL,NULL,10);

INSERT INTO MEM
VALUES(3,'USER3','PASS3','홍길삼',NULL,NULL,NULL,NULL,30);

INSERT INTO MEM
VALUES(4,'USER4','PASS4','홍길사',NULL,NULL,NULL,NULL,20);
...
/*
    ...
    컬럼을 선정하지 않고 INSERT시에 NULL이 아닌 기본 값을 INSERT 하고자 한다.
    미리 값을 세팅해 둘 수 있다.
