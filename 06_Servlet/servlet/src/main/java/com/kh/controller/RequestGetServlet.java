...
public class RequestGetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * 첫번재 매개변수인 request에는 요청시 전달된 내용들이 담겨있음(사용자가 입력한 값,요청방식 , 요청자의 url등등..)
		 * 두번째 매개변수인 response에는 요청 처리 후 응답에 사용되는 객체(어떤 타입으로 응답을 할지, 어떤 값을 응답할지 등을 넣어주면됨)
		 * 
		...
		double height = Double.parseDouble(request.getParameter("height")); //"180.2" -> 180.2
