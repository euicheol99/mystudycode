...
public class B_Array {
	public static void main(String[] args) {
		...
		/*
		 * arr.hashCode();
		 * null을 가지고 있는 참조변수에 접근해서 다른 정보를 구하고 하자면 (함수를 실행하면)
		 * 항상 오류가 발생한다.
		 * 
		...
		*/
		...
		/*
		 * 연결이 끊어진 기존 배열은 Heap 영역에 둥둥 떠다닌다.(어떤 변수에도 참조되지 않는 상태,불러올 수 없는 메모리)
		...
		System.out.println(arr2 ==arr3); //true,참조변수는 주소를 나타냄
