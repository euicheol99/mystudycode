...
public class A_for {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("아메리카노 몇 잔을 구매하시겠습니가?(가격1500원) :");
		count=sc.nextInt();
		
		int sum=0;
		for(int i=0; i < count; i++) {
			sum += 1500;
			System.out.println((i+1)+"번째 반복중... 누적금액 :" + sum);
		}
		...
		*/
		 ...
		 * 
		 * Math.random() 호출시 -> 0.0~0.9999999999999999999999사이의 랜덤값을 반환
		 * 
		 * int num = math.random(); // double형의 random 수이기 때문에 int로 받을 수 없음.
		 * 
		 * int num = (int)Math.random(); (0.0~0.9999999999999999999999)-> 무조건 0 (0~0)
		 * int num = (int)(Math.random()*10)+1; (0~9.99999999999999999999) -> 1~10
		...
		*/
		...
		//random(1~10)한 숫자 n을 생성해서 1부터 n까지의 모두 더한 값을 출력
		//random 수 :n
		//1~n까지의 합: xxx
		...
		*/
		...
		// random(5~50)한 숫자 n을 생성 후 1부터 n까지의 숫자 중 짝수만 출력
