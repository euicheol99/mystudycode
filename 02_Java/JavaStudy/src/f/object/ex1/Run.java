...
public class Run {
	/*
	 	...
	 	5. 추상화 과정
	 		...
	 		3) 추출한 것들을 가지고 내가 구현하고자 하는 프로그램의 "실질적인 목적"에 맞춰 불필요한 속성, 기능을 제거
	 		4) 최종적으로 추려진 속성들을 어떤 자료형, 어떤 변수명으로 사용할 것인지 정의
	 		
	 		ex) 학생 관리 프로그램
	 		1) 학생관련 객체(김민수훈련생...최지원훈련생...김민지훈련생...)
	 		2) 공통적인 속성 및 기능(이름,나이,주소,전화번호,키,몸무게,머리색,발사이즈 등등)
	 	...
	 	6. 추상화한 객체를 프로그램에 적용시키기
	 		...
	 		2) "배열"로 프로그램을 만든다.
	 			...
	 			나이를 보관하는 배열 int[] age ={55,60...} -> name과 age 배열간의 순서를 보장하지 않는다.
