...
public class Run {
	 ...
	 * 	오버라이딩 후: Man클래스(자식 클래스)의 toString()을 실행
	 * 
	 * 	오버라이딩이란
	...
	public static void main(String[] args) {
		...
		//객체가 생성되어있다면 객체정보를 보기 위해서 참조변수를 출력하는 순간 무조건 toString 메서드가 호출된다.
		//참조변수에 객체의 주소가 없고 null이라면 null이 출력된다.
		//String 타입을 호출하면 문자열이 출력되는 것으로 보아 String의 toString도 오버라이딩 되어있다.
	}
}
