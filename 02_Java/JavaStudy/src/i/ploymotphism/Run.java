...
public class Run {
	...
	public static void main(String[] args) {
		 ...
		 * 	(부모클래스가 올 수 있다)/	(자식클래스로 생성할 수 있음)	-> 업캐스팅
		...
		((CheeseCake)c1).milky(); // -> 다운캐스팅 : 자식의 참조변수로 타입을 변경(업캐스팅관계일 대만 가능)
		
		//CheeseCake c2 = new Cake();
		//실제 메모리 공간이 Cake이므로 CheeseCake공간에 접근할 수 없음.
