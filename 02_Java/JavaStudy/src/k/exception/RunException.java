...
//			sc.close();
	...
	// 2. throw : 여기서 예외를 처리하지않고 현재 이 메서드를 호출한 곳으로 예외처리를 떠넘기겠다.
	public void method02() {
		/*
		 * CheckedException : 반드시 예외처리를 해야하는 예외들 -> 조건문을 미리 제시할 수 없음(왜? 예측이 불가한 곳에서 문제가
		 * 발생할 수 있기 때문에) -> 외부 매개체와 입출력이 일어날 때 발생할 수 있다.
		 */
