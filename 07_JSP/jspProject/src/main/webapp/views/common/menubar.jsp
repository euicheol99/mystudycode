...
<head>
    ...
    <style>
        ...
        .nav-area{background: rgb(17, 14, 196);}
        .menu{
            display: table-cell;
            width: 150px;
            height: 50px;
...
<body>
    ...
    <div class="login-area">
    	<c:choose>
    		<c:when test="${empty sessionScope.loginUser}">
		        ...
		        <script>
		        	function enrollPage(){
		        		//location.href="${pageContext.request.contextPath}/view/member/memberEnrollForm.jsp"
		        		//웹 애플리케이션의 디렉터리구조가 url에 노출되면 보안에 취약해진다
    ...
    <div class="nav-area">
        ...
        <div class="menu"><a href="${pageContext.request.contextPath}/list.no?npage=1">공지사항</a></div>
