    ...
    <form action="/insert.th" method="post" enctype="multipart/form-data">
        <table border="1" align="center">
            ...
            <tr>
                <th>작성자</th>
                <td colspan="3">
                    <input type="text" value="${loginUser.userId}" name="boardWriter" readonly>
                </td>
            </tr>
            <tr>
                <th>제목</th>
        ...
        <div style="display: none;">
            <input type="file" name="tfile" id="file1" required onchange="loadImg(this, '#tumbnail-img')">
            <input type="file" name="files" id="file2" onchange="loadImg(this, '#content-img1')">
            <input type="file" name="files" id="file3" onchange="loadImg(this, '#content-img2')">
            <input type="file" name="files" id="file4" onchange="loadImg(this, '#content-img3')">
        </div>
