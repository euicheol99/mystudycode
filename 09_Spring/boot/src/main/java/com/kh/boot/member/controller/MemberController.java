...
public class MemberController {
    ...
    스프링컨테이너가 해당 메서드를 호출할 때 자동으로 매게변수로 주입해준다.
    * */
    /*
...
//
//        //url재요청을 원할 시 return 내용을 redirect:재요청 url로 해주면 됨
//        return "redirect:/";
//    }

    /*
    3. ModelAndView 객체를 이용한 방법-> 데이터를 담고 리턴형식까지 지정할 수 있음
    */
//    @PostMapping("login.me")
